...
@section('content')
<div class="pagetitle">
    <h1><i class="bi bi-plus-circle-fill"></i> Nuevo artículo</h1>
    <nav>
        <ol class="breadcrumb">
    ...
    <div class="card-body">
      ...
      <form class="row g-3 row-p" method="POST" action="#" enctype="multipart/form-data">
        ...
        <div class="confirm-register">
          <button type="submit" class="btn btn-success btn-p"><i class="bi bi-check-circle-fill"></i>&nbsp;&nbsp;Registrar artículo</button>
